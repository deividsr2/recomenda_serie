...
import base64
#teste background tela 1 -----------------------------


#inicio----------------------------------------------------------------------------
def tela_inicial():
    
    st.write("# E ai terminou de ver aquela serie top e nao sabe o que fazer?")
    
    if st.button("Quero recomendações"):
        st.session_state.tela_atual = "tela2"
    st.image('bad.jpg')    
# Read the SVG file as bytes

#----------------------------------------------------------------------------------------------
def tela_2():
    st.write("# Aqui você tem ")
    #user_input = st.text_input("Digite o nome da serie que deseja")
    if st.button("clique aqui para fazer uma nova pesquisa"):
 ...
 #########################################################################################################################################    
  #venv\Scripts\activate
    ...
    bt1.button('Pedir recomendações')
    #bt2.button('Nova consulta')

        # Adicionando o botão



    #fim da config botoes////////////////////////////////////////////////////////////////////////////////////////////////////////
...
def main():
    ...
    if st.session_state.tela_atual == "tela_inicial":
        tela_inicial()
    elif st.session_state.tela_atual == "tela2":
        tela_2()
